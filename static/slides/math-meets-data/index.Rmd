...
* Create a document matrix where a document corresponds to a participant
  ...
  + Are interested in the __infrequent__ words
  
  + Use a transformed frequency value: $\log(\frac{n_{word}}{n_{total words}} +1)$ 
  
  + Decrease dimensions of term-document matrix using various dimensionality reduction methods
