...
2. Instead of raw counts or tf-idf values, use a transformed frequency value

  + $\log(\frac{n_{word}}{n_{total words}} +1)$ 
  
3. Explore dimensionality reduction methods to reduce dimensions of term-document matrix from many $\rightarrow$ 2
